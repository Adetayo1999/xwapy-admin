...
import { OverviewMetricsCardProps } from "..";
...
export const OverviewMetricsCard: React.FC<OverviewMetricsCardProps> = ({
  ...
  return (
    <div className="bg-[#F2F1EB] rounded-2xl w-full md:w-fit md:min-w-[13.313rem] h-[8.813rem] p-8 flex flex-col">
      <h4 className="text-[#000000] text-sm font-medium mb-2">{title}</h4>
      <h1 className="font-bold text-secondary text-2xl md:text-3xl mb-2">
        {currency
